...
require 'fastlane/plugin/enumerated_translations/version'

Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-enumerated_translations'
  spec.version       = Fastlane::EnumeratedTranslations::VERSION
